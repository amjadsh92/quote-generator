...
//       <p
//         id="text"
//         className={`text-center fs-6  position-relative ${quoteBox.quoteTextColor} ${isFading ? "fade-out" : "fade-in"}`}
//       >
//         {(
//           <FontAwesomeIcon icon={faQuoteLeft} className="quote1 me-2 fs-2" />
//         )}{" "}
//         {!hideQuote ? quoteBox.quote : ""}
//       </p>
//       <p
//         id="author"
//         className={`author text-end ${quoteBox.quoteTextColor} ${isFading ? "fade-out" : "fade-in"}`}
//       >
//         {!hideQuote && (
//           <>
//             <span className="me-1">-</span> {quoteBox.author}
...
//         <button
//           className={`quote btn btn-primary fade-button ${quoteBox.backgroundColor} btn-hover-light border-0`}
//           onClick={changeQuote}
//         >
//           new quote
//         </button>
